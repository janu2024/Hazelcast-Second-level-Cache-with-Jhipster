...
/**
 * REST controller for managing {@link com.demo.app.domain.Profile}.
 */
@RestController
@RequestMapping("/api")
public class ProfileResource {
    ...
    private static final String ENTITY_NAME = "test2Profile";
    ...
    public Profile getProfileByName(@PathVariable Long name) {
        log.debug("REST request to get Profile : {}", name);
        Profile profileDTO = profileService.findByOne(name);
        return profileDTO;
    }
